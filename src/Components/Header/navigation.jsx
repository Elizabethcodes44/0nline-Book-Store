      ...
      <ul className="flex relative space-x-4">
        ...
        {Menus.map((menu, i) => (
          <li key={i} className="w-16">
            ...
            <Link 
            to={menu.link}className="flex flex-col text-center pt-6 cursor-pointer" onClick={() => setActive(i)}>
              <span className={`${i === active && "-mt-6"} duration-500 text-xl cursor-pointer`}>
